...
def getText(nodeList):
    songs = { }
    i = 0
    for node in nodeList['Musica']:
        songs[i] = {'Titulo': node['CancionFavorita']['Titulo'], 'Autor': node['CancionFavorita']['Autor'], 'Grupo': node['CancionFavorita']['Grupo']}
        i += 1
    return songs
